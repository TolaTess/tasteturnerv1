...
//       familyList =
//           widget.settings['familyMembers'] as List<Map<String, dynamic>>;
//     } else {
//       familyList.insert(0, {
//         'name': userService.currentUser?.displayName,
//         'age': 'adult',
//         'calorieTarget': userService.currentUser?.settings['foodGoal'],
//         'meals': []
//       });
//     }
//   }
...
//     final user =
//         widget.familyMode ? familyList[selectedUserIndex] : familyList[0];
//     final double cardMaxWidth = widget.familyMode ? 400 : double.infinity;
//     return Center(
//       child: SizedBox(
//         width: cardMaxWidth,
//         child: Stack(
...
//             // Main Card
//             Container(
//               width: getPercentageWidth(95, context),
...
//                 boxShadow: [
//                   BoxShadow(
//                     color: kAccentLight.withOpacity(0.18),
//                     blurRadius: 12,
...
//                               ),
//                             ),
//                             // Aggregate tags at top right
//                             Spacer(),
//                             if (user['meals'].isNotEmpty)
//                               Builder(
//                                 builder: (context) {
//                                   final Set<String> allTags = {};
//                                   for (final meal in user['meals']) {
//                                     final tags =
//                                         meal is Map && meal['tags'] is List
//                                             ? meal['tags'] as List
//                                             : <dynamic>[];
...
//                       Center(
//                         child: Text(
//                           'No meal plan for ${user['name']} yet',
//                           style: TextStyle(
//                             color: Colors.white,
//                             fontSize: getPercentageWidth(4, context),
//                           ),
...
//                             itemCount: user['meals'].length,
//                             itemBuilder: (context, index) {
//                               final meal = user['meals'][index];
//                               return Container(
...
//                                     ? kAccent
//                                     : Colors.grey[800],
//                                 backgroundImage: AssetImage(fam['avatar']),
