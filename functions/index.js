              ...
              if (Object.prototype.hasOwnProperty.call(innerMap, itemKey)) {
                ...
                if (item && typeof item === "object") {
                  ...
                  if (item.macros && typeof item.macros === "object") {
                    // Handle both number and string values in macros
                    protein = typeof item.macros.protein === "number" 
                      ? item.macros.protein 
                      : (parseFloat(item.macros.protein) || 0);
                    carbs = typeof item.macros.carbs === "number" 
                      ? item.macros.carbs 
                      : (parseFloat(item.macros.carbs) || 0);
                    fat = typeof item.macros.fat === "number" 
                      ? item.macros.fat 
                      : (parseFloat(item.macros.fat) || 0);
